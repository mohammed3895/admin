...
import DeskTabMobile from "./DeskTabMobile";
...
const DeskTab = ({ project }: ProjectProps) => {
  ...
  return (
    <>
      <div className="hidden h-full min-h-svh w-full flex-1 items-start justify-between gap-6 overflow-x-auto px-4 md:flex">
