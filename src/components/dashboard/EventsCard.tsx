...
const EventsCard = ({ event }: EventCardprops) => {
  return (
    <div className="flex w-full cursor-pointer items-center justify-start gap-3 rounded-2xl bg-purple-2 px-3 py-4 transition-colors ease-in-out hover:bg-purple-200 lg:px-4 lg:py-5">
      <div className=" flex items-center justify-center rounded-xl bg-purple-2 p-2 md:p-3.5">
      ...
      <div className="flex w-full items-center">
        <div className="flex w-3/4 flex-col justify-start gap-1">
          ...
          <h3 className="text-xs font-medium text-gray-600">{event.data}</h3>
        </div>
