...
const About = () => {
  return (
    <div className="flex h-full w-full flex-col gap-6 lg:flex-row">
      <div className="flex h-full w-full flex-col gap-8 rounded-xl p-4 lg:w-fit lg:min-w-96 lg:flex-row">
        <div className="flex h-full w-full flex-col items-start justify-start gap-6 lg:max-w-96">
          <div className="flex w-full items-center justify-between rounded-xl  px-4 py-6 shadow-lg dark:shadow-zinc-900 lg:max-w-96">
          ...
          <div className="flex w-full flex-col items-center justify-start gap-3 rounded-xl p-6 shadow-xl dark:shadow-zinc-900 lg:max-w-96">
      ...
      <div className="flex h-full w-full flex-col gap-4 rounded-xl">
        <div className="flex h-80 w-full flex-col rounded-xl  p-4 shadow-xl dark:shadow-zinc-900 lg:h-96">
          <textarea
